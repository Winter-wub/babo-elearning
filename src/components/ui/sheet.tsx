...
// Sheet reuses the Radix Dialog primitive — the overlay and focus-trap
// behaviour are identical; only the content positioning changes.
  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        // Side-specific positioning and slide direction
    ...
    >
      {children}
      {/* Close button — top-right corner regardless of side */}
