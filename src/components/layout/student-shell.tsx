 ...
 */
export function StudentShell({ children, appName, logoUrl }: StudentShellProps) {
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      <StudentSidebar open={sidebarOpen} onClose={handleClose} appName={appName} logoUrl={logoUrl} />
