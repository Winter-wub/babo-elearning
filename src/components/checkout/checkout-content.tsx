...
export function CheckoutContent({ cart }: CheckoutContentProps) {
          ...
          <Card className="bg-muted/50">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <CopyButton text="กสิกรไทย" field="bank" />
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-muted-foreground">เลขบัญชี</p>
                  <p className="font-mono font-medium">XXX-X-XXXXX-X</p>
                </div>
                <CopyButton text="XXXXXXXXXX" field="account" />
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <CopyButton text="ชื่อ นามสกุล" field="name" />
              </div>
              <div className="flex items-center justify-between">
                <div>
